...
const seedData = async () => {
  try {
    ...
    // Create demo users (Admin, HR, Manager, Employee, Candidate)
    ...
    // Create employee records for Admin, HR, Manager, and Employee
    ...
    const employees = [
      ...
      {
        userId: userResults.insertedIds[3],
        firstName: 'Employee',
        lastName: 'User',
    ...
    console.log(`✅ Created ${employeeResults.insertedCount} employee records`);
    ...
    console.log('Admin (Full access): admin@mastersolisinfotech.com / admin123');
    console.log('HR (HR access): hr@mastersolisinfotech.com / HR@2024!');
    console.log('Manager (Team access): manager@mastersolisinfotech.com / manager123');
    console.log('Employee (Basic access): employee@mastersolisinfotech.com / employee123');
    console.log('Candidate (Job portal): candidate.demo@mastersolisinfotech.com / candidate123');
    console.log('\n📋 Created Resources:');
    console.log(`- ${departmentResults.insertedCount} departments`);
    console.log(`- ${userResults.insertedCount} users (Admin, HR, Manager, Employee)`);
    console.log(`- ${employeeResults.insertedCount} employee records`);
    console.log(`- 1 candidate user`);
